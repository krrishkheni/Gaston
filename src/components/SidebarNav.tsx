      ...
      >
        ...
        <div className="flex flex-col gap-1.5 flex-grow font-mono text-xs">
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-2xl font-medium transition-all duration-200 text-left active:scale-[0.98] ${
              activeTab === 'dashboard'
        ...
        <div className="mt-auto flex flex-col gap-3 pt-4">
          ...
          <button
            ...
            className={`w-full py-3.5 px-4 rounded-2xl font-bold font-mono text-xs tracking-wider flex items-center justify-center gap-2 transition-all active:scale-[0.98] ${
              isEmergency
